...
const LandingIntroduction = () => {
  ...
  return (
    <Grid item sx={{ direction: "rtl" }} xs={isDownSmallScreen ? 12 : 6}>
      <Typography
        sx={{
      ...
      >
        پیشبرد سازمانی و افزایش سطح هوشمندی با ماژول‌های؛ مدیریت منابع انسانی، مدیریت زنجیره تامین، مدیریت ارتباط با
        مشتریان، مدیریت مالی و حسابداری، در یک نگاه با بهبود کارایی و افزایش توانمندی‌های سازمانی، تبدیل به محوری جهت
        ارتقاء عملکرد و بهره‌وری گردیده است.
      </Typography>
    </Grid>
  );
};
